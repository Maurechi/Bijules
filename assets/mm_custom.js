...
*/
  ...
  function init_toggler() {
    ...
    $('#sizeguide-toggler').click( function() {
      $( "#sizeguide-toggler" ).toggleClass('active');
      $('#sizeguide').slideToggle(500);
      return false; 
    });

    $('#details-tab-toggler').click( function() {
      $( "#details-tab-toggler" ).toggleClass('active');
      $('#details-tab').slideToggle(500);
      return false; 
    });
